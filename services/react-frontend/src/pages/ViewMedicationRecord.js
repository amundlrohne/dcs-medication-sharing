...
const ViewMedicationRecord = () => {
    ...
    useEffect(async () => {
        ...
        if (consent_id !== undefined) {
            ...
            setPatientName(
                parsedJSON.entry[0].resource.entry[0].resource.subject.display
            );
        }
    }, []);
        ...
        <div>
            <div className="medication-record-container">
                ...
                {records.map((record_elem, idx) => {
                    return (
                        <div className="record-elem" id={consentID} key={idx}>
                            ...
                            <label htmlFor="effectivedatetime">
                                ...
                                <input
                                    ...
                                    value={
                                        record_elem.resource.effectiveDateTime
                                    }
                                />
                            </label>
                            ...
                            <label htmlFor="doctorsnote">
                                ...
                                <textarea
                                    ...
                                    type="text"
                                    name="doctorsnote"
                                    value={record_elem.resource.note[0].text}
                                />
                            </label>
                            ...
                            <label htmlFor="status">
                                ...
                                <input
                                    ...
                                    type="text"
                                    name="status"
                                    value={record_elem.resource.status}
                                />
                            </label>
                            ...
                            <label htmlFor="dosagesequence">
                                ...
                                <input
                                    ...
                                    name="dosagesequence"
                                    value={
                                        record_elem.resource.dosage[0].sequence
                                    }
                                />
                            </label>
                            ...
                            <label htmlFor="dosagenote">
                                ...
                                <textarea
                                    ...
                                    type="text"
                                    name="dosagenote"
                                    value={record_elem.resource.dosage[0].text}
                                />
                            </label>
                        </div>
                    );
